...
return [
    ...
    */
    ...
    'allowed_methods' => ['*'],
// 'allowed_origins' => ['*'],
    'allowed_origins' => [env('FRONTEND_URL'),'https://bomsaborr.shop','https://api.bomsaborr.shop', 'http://localhost:443', 'http://localhost:8081','http://localhost:8080'], // JÁ MODIFICADO PARA VOCÊ
